...
static const yytype_int16 yyrline[] =
{
      ...
      82,    87,    97,    96,   106,   115,   121,   127,   105,   137,
     136,   154,   156,   161,   171,   176,   186,   185,   198,   211,
     221,   225,   235,   239,   241,   243,   245,   247,   252,   254,
     260,   266,   276,   285,   289,   297,   304,   309,   316,   322,
     328,   315,   341,   349,   357,   365,   373,   381,   389,   394,
     402,   410,   415,   422,   429,   434,   436,   438,   440,   445,
     451,   450,   464,   466,   470,   480
};
#endif
...
{
  "$end", "error", "$undefined", "IF", "ELSE", "ASSIGN", "RETURN",
  "WHILE", "INT", "VOID", "EQ", "LT", "PLUS", "LTE", "GT", "GTE", "DIFF",
  "MINUS", "TIMES", "OVER", "ID", "NUM", "LPAREN", "RPAREN", "LBRACES",
  "RBRACES", "LBRACK", "RBRACK", "COMMA", "SEMI", "ERROR", "$accept",
  "programa", "declaracao_lista", "declaracao", "id", "num",
...
#line 97 "tiny.y"
                        { 
                          ...
                          yyval->child[0]->type = savedExpType;
...
#line 1958 "tiny.tab.c"
    break;

  case 61:
#line 411 "tiny.y"
                        { yyval = yyvsp[0]; }
#line 1964 "tiny.tab.c"
    break;
...
#line 1986 "tiny.tab.c"
    break;

  case 64:
#line 430 "tiny.y"
                        { yyval = yyvsp[0]; }
#line 1992 "tiny.tab.c"
    break;

  case 65:
#line 435 "tiny.y"
                        { yyval = yyvsp[-1]; }
#line 1998 "tiny.tab.c"
    break;

  case 66:
#line 437 "tiny.y"
                        { yyval = yyvsp[0]; }
#line 2004 "tiny.tab.c"
    break;

  case 67:
#line 439 "tiny.y"
                        { yyval = yyvsp[0]; }
#line 2010 "tiny.tab.c"
    break;
...
#line 2019 "tiny.tab.c"
    break;

  case 69:
#line 446 "tiny.y"
                        { yyval = NULL; }
#line 2025 "tiny.tab.c"
    break;
...
#line 2070 "tiny.tab.c"
    break;

  case 75:
#line 481 "tiny.y"
                        { yyval = yyvsp[0]; }
#line 2076 "tiny.tab.c"
    break;


#line 2080 "tiny.tab.c"
