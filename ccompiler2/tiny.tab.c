...
#line 465 "tiny.y"
                        { yyval = yyvsp[0]; }
#line 1861 "tiny.tab.c"
    break;

  case 73: /* args: %empty  */
#line 466 "tiny.y"
                      { yyval = NULL; }
#line 1867 "tiny.tab.c"
    break;
